...
namespace OkulOtomasyon.Business.Concrete.Managers
{
    public class StudentsParentsManager : IStudentsParentsService
    {
        ...
        public StudentsParents updateStudentsParents(StudentsParents studentsParents)
        {
            return _parentsDal.Update(studentsParents);
        }

        public StudentsParents GetStudentsParents(string studentsId)
        {
